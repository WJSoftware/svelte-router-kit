...
<Content role="tabpanel">
    ...
    <p>
        The active style on the tab is applied using the <code>activeBehavior</code> action, which applies the
        <code>is-active</code> class when the associated route is active.
    </p>
</Content>
<Container>
    <Columns.Root>
